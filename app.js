...
function openProfileDetail(rid) {
  ...
  var html = '<div class="profile-hero" style="border-radius:20px 20px 0 0;overflow:hidden"><div class="profile-gallery" onscroll="updateProfileDots(this)" style="height:280px">' + gallery + '</div>' + dots + '</div>' +
    '<div style="padding:20px 24px">' +
      ...
      '<button onclick="document.getElementById(\'profileDetailModal\').classList.remove(\'active\')" style="width:100%;margin-top:8px;padding:12px;border:1px solid rgba(255,255,255,.1);border-radius:980px;background:rgba(255,255,255,.04);color:rgba(255,255,255,.6);font-size:.82rem;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px"><i class="fa-solid fa-arrow-left"></i> Go Back</button>' +
    '</div>';
